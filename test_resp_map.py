...
class ImageFragment():
    def __init__(self, img_path: str, focal_length: float = 2000, layer_num: int = 1) -> None:
        ...
        self.resp_map = msop_utils.nms(msop_utils.get_corner_resp_map(self.grayscale_img))

        self.cylindrical_img = vis_utils.show_resp(self.cylindrical_img, self.resp_map)
...
if __name__ == '__main__':
    ...
    for idx in range(1, len(img_frag_list)):
        ...
        matched = vis_utils.show_matched(main_frag.cylindrical_img, frag.cylindrical_img, mv_pairs)
